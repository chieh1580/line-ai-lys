...
【單項價格】
背部撥經 60分鐘 原價1,800元（會員1,620／VIP 1,440）
腿部撥經 60分鐘 原價1,800元（會員1,620／VIP 1,440）
臉部撥經 90分鐘 原價2,900元（會員2,610／VIP 2,320）
胸部撥筋 45分鐘 原價1,500元（會員1,350／VIP 1,200）
腹部撥經 45分鐘 原價1,500元（會員1,350／VIP 1,200）
胯部八髎撥經 30分鐘 原價1,100元（會員990／VIP 880）
無煙艾灸 60分鐘 原價1,200元（會員1,080／VIP 960）
循環美容儀 30分鐘 原價500元（會員450／VIP 400）

【療癒撥經套餐】
A套餐：全身撥經 120分鐘 原價3,200元（會員2,880／VIP 2,560）
B套餐：臉／胸／腹撥經 150分鐘 原價4,900元（會員4,410／VIP 3,920）
C套餐：臉／胸撥經 120分鐘 原價3,900元（會員3,510／VIP 3,120）
D套餐：胸／腹撥經 90分鐘 原價3,000元（會員2,700／VIP 2,400）
E套餐：背／腹撥經 130分鐘 原價3,600元（會員3,240／VIP 2,880）
F套餐：背／胸撥經 130分鐘 原價3,800元（會員3,420／VIP 3,040）
...
.topbar-logo{width:32px;height:32px;background:#B08D6E;border-radius:7px;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:700;color:#fff}
...
.tab.active{color:#B08D6E;border-bottom:2px solid #B08D6E;font-weight:600}
...
.stat-n.orange{color:#B08D6E}
.stat-n.green{color:#3b6d11}
.stat-l{font-size:11px;color:#b0a090;margin-top:2px}
.notify{margin:8px 20px 4px;background:#FAF5EC;border:0.5px solid #D8C8B0;border-radius:8px;padding:11px 14px;display:flex;align-items:center;gap:10px}
.notify-dot{width:7px;height:7px;border-radius:50%;background:#B08D6E;flex-shrink:0}
.notify-txt{font-size:12px;color:#6B4F3A}
...
.card.paused{border-left:3px solid #B08D6E;border-radius:0 10px 10px 0;background:#FAF5EC}
.card.active{border-left:3px solid #6abf69;border-radius:0 10px 10px 0}
.ava{width:40px;height:40px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:600;flex-shrink:0;background:#f0ebe3;color:#6B4F3A;overflow:hidden}
...
.btn-stop{background:#faf0f5;color:#6b2858;border-color:#D8C8B0}
...
.login-logo{width:48px;height:48px;background:#B08D6E;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:18px;font-weight:700;color:#fff;margin:0 auto 16px}
...
.login-box button{width:100%;padding:10px;background:#B08D6E;color:#fff;border:none;border-radius:6px;font-size:14px;font-weight:600;cursor:pointer}
.err{color:#B08D6E;font-size:12px;margin-top:8px}
...
textarea:focus{outline:none;border-color:#B08D6E}
.btn-row{display:flex;gap:10px;margin-top:16px}
.btn-save{background:#B08D6E;color:#fff;border:none;border-radius:6px;padding:10px 24px;font-size:13px;font-weight:600;cursor:pointer}
.btn-save:hover{background:#6B4F3A}
.btn-reset{background:#fff;color:#6B4F3A;border:0.5px solid #D8C8B0;border-radius:6px;padding:10px 24px;font-size:13px;font-weight:500;cursor:pointer}
.btn-reset:hover{background:#FAF5EC}
.toast{position:fixed;bottom:20px;right:20px;background:#2d1f14;color:#f5ede0;padding:10px 18px;border-radius:6px;font-size:13px;display:none;z-index:999}
</style>
</head>
<body>
    ...
    return {
        ...
        "contents": {
            ...
            "header": {
                ...
                "contents": [
                    {"type": "text", "text": "歡迎來到 LYS 美妍SPA館", "weight": "bold", "size": "lg", "color": "#6B4F3A"},
                    {"type": "text", "text": "美容撥經｜撥經教學｜溫和式舒壓護理", "size": "md", "margin": "sm", "color": "#555555"}
                ],
                "paddingAll": "20px", "backgroundColor": "#FAF5EC"
            },
            "body": {
                "type": "box", "layout": "vertical",
                "contents": [
                    ...
                    {"type": "text", "text": "您想了解什麼呢？", "weight": "bold", "size": "md", "margin": "lg", "color": "#2d1f14"},
                    {
                        ...
                        "contents": [
                            {"type": "button", "action": {"type": "message", "label": "服務項目與價格", "text": "你們有什麼服務？價格怎麼算？"}, "style": "primary", "color": "#B08D6E", "height": "sm"},
                            {"type": "button", "action": {"type": "message", "label": "療癒套餐介紹", "text": "有什麼套餐可以選？"}, "style": "primary", "color": "#C4A47A", "height": "sm"}
                        ]
                    },
                    {
                        "type": "box", "layout": "horizontal", "spacing": "sm", "margin": "sm",
                        "contents": [
                            {"type": "button", "action": {"type": "message", "label": "新客體驗價", "text": "第一次去有什麼推薦的嗎？"}, "style": "primary", "color": "#D4BFA0", "height": "sm"},
                            {"type": "button", "action": {"type": "uri", "label": "預約撥經", "uri": "https://www.ezpretty.com.tw/ezpretty/aio#/5babc5749a6c9273ce0893bb9bd9b700"}, "style": "primary", "color": "#C47F5A", "height": "sm"}
                        ]
                    },
                    {"type": "separator", "margin": "lg"},
                    {"type": "button", "action": {"type": "message", "label": "🔮 開始我的專屬測驗", "text": "開始我的專屬測驗"}, "style": "primary", "color": "#C47F5A", "margin": "lg", "height": "sm"},
...
def build_quiz_q1_flex():
    ...
    return {
        ...
        "contents": {"type": "bubble", "body": {"type": "box", "layout": "vertical", "paddingAll": "20px", "contents": [
            {"type": "text", "text": "專屬測驗 ①/③", "size": "xs", "color": "#B08D6E", "weight": "bold"},
...
def build_quiz_result_flex(teacher, q1, q2, q3):
    ...
    return {
        ...
        "contents": {"type": "bubble", "body": {"type": "box", "layout": "vertical", "paddingAll": "20px", "contents": [
            {"type": "text", "text": "✨ 分析完成！", "weight": "bold", "size": "lg", "color": "#6B4F3A"},
            {"type": "separator", "margin": "md"},
            {"type": "text", "text": f"根據您的回答，您目前{body_part}比較需要照顧，加上生活節奏「{q2}」，很適合透過撥經來好好舒緩放鬆一下哦！", "wrap": True, "size": "sm", "color": "#666666", "margin": "md"},
            {"type": "box", "layout": "vertical", "margin": "lg", "paddingAll": "15px", "backgroundColor": "#FAF5EC", "cornerRadius": "10px", "contents": [
                {"type": "text", "text": f"為您推薦：{teacher}", "weight": "bold", "size": "md", "color": "#6B4F3A"},
                {"type": "text", "text": f"新客首次體驗「背部鬆經」\n60 分鐘只要 1,280 元！", "wrap": True, "size": "sm", "color": "#555555", "margin": "sm"}
            ]},
            {"type": "button", "action": {"type": "uri", "label": "立即預約體驗", "uri": "https://www.ezpretty.com.tw/ezpretty/aio#/5babc5749a6c9273ce0893bb9bd9b700"}, "style": "primary", "color": "#B08D6E", "margin": "lg", "height": "sm"},
            {"type": "button", "action": {"type": "message", "label": "想先了解更多", "text": "你們有什麼服務？價格怎麼算？"}, "style": "link", "color": "#B08D6E", "margin": "sm", "height": "sm"}
        ]}}
    }
...
def build_faq_menu_flex():
    ...
    return {
        ...
        "contents": {"type": "bubble", "body": {"type": "box", "layout": "vertical", "paddingAll": "20px", "contents": [
            {"type": "text", "text": "撥經解惑室", "weight": "bold", "size": "lg", "color": "#6B4F3A"},
            {"type": "text", "text": "點選您想了解的問題吧！", "size": "sm", "color": "#666666", "margin": "md"},
...
def build_faq_answer_flex(question):
    ...
    return {
        ...
        "contents": {"type": "bubble", "body": {"type": "box", "layout": "vertical", "paddingAll": "20px", "contents": [
            {"type": "text", "text": question, "weight": "bold", "size": "md", "color": "#6B4F3A", "wrap": True},
            {"type": "separator", "margin": "md"},
            {"type": "text", "text": answer, "wrap": True, "size": "sm", "color": "#555555", "margin": "md"},
            {"type": "separator", "margin": "lg"},
            {"type": "button", "action": {"type": "message", "label": "看其他問題", "text": "撥經解惑室"}, "style": "link", "color": "#B08D6E", "margin": "md", "height": "sm"},
            {"type": "button", "action": {"type": "uri", "label": "立即預約體驗", "uri": "https://www.ezpretty.com.tw/ezpretty/aio#/5babc5749a6c9273ce0893bb9bd9b700"}, "style": "primary", "color": "#B08D6E", "margin": "sm", "height": "sm"}
        ]}}
    }
    ...
    return {
        ...
        "contents": {
            ...
            "body": {
                "type": "box", "layout": "vertical",
                "contents": [
                    {"type": "text", "text": "太好了！", "weight": "bold", "size": "lg", "color": "#6B4F3A"},
    ...
    return {
        ...
        "contents": {
            ...
            "body": {
                "type": "box", "layout": "vertical",
                "contents": [
                    {"type": "text", "text": "預約資料收到囉！", "weight": "bold", "size": "lg", "color": "#6B4F3A"},
                    {"type": "separator", "margin": "lg"},
...
def build_notify_boss_flex(customer_name, name, phone, service, time_str):
    ...
    return {
        ...
        "contents": {
            ...
            "header": {
                "type": "box", "layout": "vertical",
                "contents": [{"type": "text", "text": "新的預約諮詢！", "weight": "bold", "size": "lg", "color": "#6B4F3A"}],
                "paddingAll": "16px", "backgroundColor": "#FAF5EC"
            },
            "body": {
                "type": "box", "layout": "vertical",
                "contents": [
                    ...
                    {"type": "separator", "margin": "lg"},
                    {"type": "button", "action": {"type": "uri", "label": "查看後台", "uri": ADMIN_URL or "https://line-ai-lys-production.up.railway.app/admin"}, "style": "primary", "color": "#B08D6E", "margin": "lg", "height": "sm"}
                ],
                "paddingAll": "16px"
            }
        }
        ...
        "contents": {
            ...
            "body": {
                ...
                "contents": [
                    ...
                    {"type": "separator", "margin": "lg"},
                    {
                        ...
                        "contents": [
                            {"type": "box", "layout": "vertical", "flex": 1, "contents": [
                                ...
                                {"type": "text", "text": "1,280", "size": "xl", "weight": "bold", "color": "#B08D6E", "align": "center"}
                            ]},
                            {"type": "box", "layout": "vertical", "flex": 1, "contents": [
                    ...
                    {"type": "separator", "margin": "lg"},
                    {"type": "button", "action": {"type": "uri", "label": "我也想體驗", "uri": "https://www.ezpretty.com.tw/ezpretty/aio#/5babc5749a6c9273ce0893bb9bd9b700"}, "style": "primary", "color": "#B08D6E", "margin": "lg", "height": "sm"}
                ],
                "paddingAll": "16px"
            }
        }
...
def build_package_carousel_flex():
    """套餐價目表 — 6 個套餐的輪播卡片"""
    bubbles = [
        _pkg_bubble("Package A", "全身撥經 Full Body", "從頭到腳完整護理，適合初次體驗或全身痠痛、循環不佳的客人",
                     "3,200", "120 min", "2,880", "2,560",
                     ["頭部撥經舒壓", "肩頸撥經舒壓", "手部舒壓撥經", "背部精雕撥經", "腰部精雕撥經", "臀部提臀撥經", "足底撥經舒壓", "小腿舒壓撥經", "大腿雕塑撥經"]),
        _pkg_bubble("Package B", "臉／胸／腹 撥經", "臉部煥顏＋胸腹全護理，適合想同時改善氣色與身體循環的客人",
                     "4,900", "150 min", "4,410", "3,920",
                     ["臉部清潔補水", "臉部精雕撥經", "頭部撥經舒壓", "肩頸撥經舒壓", "胸部疏通撥經", "腹部雕塑撥經", "臍燭精油艾灸貼"]),
        _pkg_bubble("Package C", "臉／胸 撥經", "臉部緊緻煥膚結合胸部舒緩，適合注重臉部保養與上半身循環的客人",
                     "3,900", "120 min", "3,510", "3,120",
                     ["臉部清潔補水", "臉部精雕撥經", "頭部撥經舒壓", "肩頸撥經舒壓", "胸部舒壓撥經"]),
        _pkg_bubble("Package D", "胸／腹 撥經", "專注胸腹部集中護理，適合想改善腹部緊繃與胸部不適的客人",
                     "3,000", "90 min", "2,700", "2,400",
                     ["胸部疏通撥經", "腹部雕塑撥經", "臍燭精油艾灸貼"]),
        _pkg_bubble("Package E", "背／腹 撥經", "背部深層放鬆加腹部溫熱舒壓，適合久坐族、腰背痠痛的客人",
                     "3,600", "130 min", "3,240", "2,880",
                     ["頭部撥經舒壓", "肩頸撥經舒壓", "手部舒壓撥經", "背部精雕撥經", "腰部精雕撥經", "臀部提臀撥經", "腹部雕塑撥經", "臍燭精油艾灸貼"]),
        _pkg_bubble("Package F", "背／胸 撥經", "背部全方位舒壓結合胸部疏通，適合上半身緊繃、長期姿勢不良的客人",
                     "3,800", "130 min", "3,420", "3,040",
                     ["胸部疏通撥經", "頭部撥經舒壓", "肩頸撥經舒壓", "手部舒壓撥經", "背部精雕撥經", "腰部精雕撥經", "臀部提臀撥經"]),
    ]
    return {
        "type": "flex",
        "altText": "療癒撥經套餐方案 A~F",
...
def build_guided_flex(user_message):
    ...
    other_buttons = []
    button_map = {
        "你們有什麼服務？價格怎麼算？": ("單項服務價格", "#B08D6E"),
        "有什麼套餐可以選？": ("療癒套餐方案", "#C4A47A"),
        "第一次去有什麼推薦的嗎？": ("新客推薦", "#D4BFA0"),
    }
    ...
    return {
        ...
        "contents": {
            ...
            "header": {
                "type": "box", "layout": "vertical",
                "contents": [{"type": "text", "text": config["title"], "weight": "bold", "size": "lg", "color": "#6B4F3A"}],
                "paddingAll": "16px", "backgroundColor": "#FAF5EC"
            },
            "body": {
                "type": "box", "layout": "vertical",
                "contents": [
                    ...
                    {"type": "box", "layout": "vertical", "margin": "md", "spacing": "sm", "contents": other_buttons + [
                        {"type": "button", "action": {"type": "uri", "label": "我想預約體驗", "uri": "https://www.ezpretty.com.tw/ezpretty/aio#/5babc5749a6c9273ce0893bb9bd9b700"}, "style": "primary", "color": "#B08D6E", "height": "sm"}
                    ]}
                ],
                "paddingAll": "16px"
            }
    ...
    messages = {
        "24hr": {
            ...
            "contents": {"type": "bubble", "body": {"type": "box", "layout": "vertical", "paddingAll": "20px", "contents": [
                ...
                {"type": "button", "action": {"type": "message", "label": "了解服務內容", "text": "你們有什麼服務？價格怎麼算？"}, "style": "primary", "color": "#B08D6E", "margin": "lg", "height": "sm"}
            ]}}
        },
        "48hr": {
            ...
            "contents": {"type": "bubble", "body": {"type": "box", "layout": "vertical", "paddingAll": "20px", "contents": [
                ...
                {"type": "button", "action": {"type": "message", "label": "第一次去推薦什麼？", "text": "第一次去有什麼推薦的嗎？"}, "style": "primary", "color": "#B08D6E", "margin": "lg", "height": "sm"}
            ]}}
        },
        "7day": {
            "type": "flex", "altText": "給自己放鬆一下吧",
            "contents": {"type": "bubble", "body": {"type": "box", "layout": "vertical", "paddingAll": "20px", "contents": [
                {"type": "text", "text": "忙碌了一週，該犒賞自己了！", "weight": "bold", "size": "md", "color": "#6B4F3A"},
...
def webhook():
    ...
    for event in body["events"]:
        ...
        # ----- 2. 檢查：按鈕引導（服務/套餐/新客） -----
        if user_message == "有什麼套餐可以選？":
            reply_messages(reply_token, [build_package_carousel_flex()])
            continue
        ...
        if any(kw in user_message for kw in BOOKING_KEYWORDS):
            reply_messages(reply_token, [{
                ...
                "contents": {"type": "bubble", "body": {"type": "box", "layout": "vertical", "paddingAll": "20px", "contents": [
                    {"type": "text", "text": "太好了！馬上幫您安排 ✨", "weight": "bold", "size": "md", "color": "#6B4F3A"},
                    {"type": "text", "text": "請點擊下方按鈕，到我們的預約系統選擇方便的時間哦！", "wrap": True, "size": "sm", "color": "#666666", "margin": "md"},
                    {"type": "button", "action": {"type": "uri", "label": "立即線上預約", "uri": "https://www.ezpretty.com.tw/ezpretty/aio#/5babc5749a6c9273ce0893bb9bd9b700"}, "style": "primary", "color": "#B08D6E", "margin": "lg", "height": "sm"}
                ]}}
            }])
            continue
