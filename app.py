...
# 老師輪流分配清單
TEACHER_ROTATION = ["懿珊老師", "微雅老師", "好羚老師", "辰玥老師", "家媛老師"]
...
【師資團隊】
懿珊老師 — 撥經技術總顧問（LYS「療育撥經」品牌創辦人，精通中醫學理並擅長食補搭配）
微雅老師 — 無痛撥經指定導師（擅長以溫柔巧勁化解深層僵硬，專注高壓族群身心平衡與助眠調理）
好羚老師 — 重度疲勞救星（專治身體僵硬多年、吃重力的身驅，精通胸腹深層疏通）
辰玥老師 — 最懂媽咪的理療師（深耕母嬰領域，更懂為母緊繃與壓力，自帶活潑開朗的正能量）
家媛老師 — 靜心療育師（散發著安定人心的溫柔氣質，服務過程安靜不打擾）
